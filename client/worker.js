...
WebWorker.prototype.fake = function() {
	var self = this
	Frame5.logger('Frame5 FAKE WebWorker init');
	var worker = new Frame5.Module(function(data) {
...
WebWorker.prototype.process = function() {
	var rpc = new self.Frame5.Module(function(data) {
...
WebWorker.prototype.load = function(fn, cb) {
	this.rpc.invoke('vm.load', [fn.toString(), true], cb)
}
